 ...
 * @author yaqiang
 */
public class FrmShanghaiMain extends javax.swing.JFrame {

    /**
     * Creates new form frmMain
     */
    public FrmShanghaiMain() {
        initComponents();
        ...
        this.DrawingPanelShanghai1.setDrawContourPolygon(true);
    }
    ...
    private void initComponents() {
        ...
        DrawingPanelShanghai1 = new DrawingPanelShanghai();
        ...
        jLabel_StartColor.setBackground(new Color(255, 255, 204));
        ...
        jLabel_EndColor.setBackground(new Color(255, 51, 0));
        ...
        DrawingPanelShanghai1.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentResized(java.awt.event.ComponentEvent evt) {
                DrawingPanelShanghai1ComponentResized(evt);
            }
        });

        javax.swing.GroupLayout DrawingPanelShanghai1Layout = new javax.swing.GroupLayout(DrawingPanelShanghai1);
        DrawingPanelShanghai1.setLayout(DrawingPanelShanghai1Layout);
        DrawingPanelShanghai1Layout.setHorizontalGroup(
            DrawingPanelShanghai1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 749, Short.MAX_VALUE)
        );
        DrawingPanelShanghai1Layout.setVerticalGroup(
            DrawingPanelShanghai1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(DrawingPanelShanghai1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(DrawingPanelShanghai1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void DrawingPanelShanghai1ComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_DrawingPanelShanghai1ComponentResized
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setScale();
    }//GEN-LAST:event_DrawingPanelShanghai1ComponentResized
    ...
    private void jCheckBox_DiscreteDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_DiscreteDataActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setDrawDiscreteData(this.jCheckBox_DiscreteData.isSelected());
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jCheckBox_GridDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_GridDataActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setDrawGridData(this.jCheckBox_GridData.isSelected());
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jCheckBox_BorderLineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_BorderLineActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setDrawBorderLine(this.jCheckBox_BorderLine.isSelected());
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jCheckBox_ContourLineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_ContourLineActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setDrawContourLine(this.jCheckBox_ContourLine.isSelected());
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jCheckBox_ContourPolygonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_ContourPolygonActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setDrawContourPolygon(this.jCheckBox_ContourPolygon.isSelected());
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jCheckBox_ClippedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_ClippedActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setDrawClipped(this.jCheckBox_Clipped.isSelected());
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jCheckBox_AntiAliasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_AntiAliasActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setAntiAlias(this.jCheckBox_AntiAlias.isSelected());
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jCheckBox_HighlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox_HighlightActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.setHighlight(this.jCheckBox_Highlight.isSelected());
    ...
    private void jTextField_HighlightKeyPressed(KeyEvent evt) {//GEN-FIRST:event_jTextField_HighlightKeyPressed
        // TODO add your handling code here:
        int key = evt.getKeyCode();
        if (key == KeyEvent.VK_ENTER) {
            this.DrawingPanelShanghai1.setHighlightIdx(Integer.parseInt(this.jTextField_Highlight.getText()));
            this.DrawingPanelShanghai1.repaint();
        }
    ...
    private void jLabel_StartColorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_StartColorMouseClicked
        ...
        this.DrawingPanelShanghai1.setStartColor(aColor);
        this.DrawingPanelShanghai1.createColors();
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jLabel_EndColorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_EndColorMouseClicked
        ...
        this.DrawingPanelShanghai1.setEndColor(aColor);
        this.DrawingPanelShanghai1.createColors();
        this.DrawingPanelShanghai1.repaint();
    ...
    private void jMenuItem_IDW_NeighbourActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_IDW_NeighbourActionPerformed
        ...
        this.DrawingPanelShanghai1.sample_Interpolate(1);
    ...
    private void jMenuItem_IDW_RadiusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_IDW_RadiusActionPerformed
        // TODO add your handling code here:
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        this.DrawingPanelShanghai1.sample_Interpolate(2);
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void jMenuItem_CressmanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_CressmanActionPerformed
        // TODO add your handling code here:
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        this.DrawingPanelShanghai1.sample_Interpolate(3);
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void jMenuItem_StreamlineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_StreamlineActionPerformed
        ...
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        try {
            this.DrawingPanelShanghai1.sample_Streamline();
        } catch (IOException ex) {
            Logger.getLogger(FrmShanghaiMain.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void jMenuItem_TestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_TestActionPerformed
        // TODO add your handling code here:
        this.DrawingPanelShanghai1.clearObjects();
        ...
        if (aFile.isFile()) {
            try {
                double[][] gridData = this.DrawingPanelShanghai1.readSuferGridData(aFile);
                this.DrawingPanelShanghai1.setGridData(gridData);
            ...
            this.DrawingPanelShanghai1.setContourValues(values);
            this.DrawingPanelShanghai1.tracingContourLines();
            this.DrawingPanelShanghai1.smoothLines();
            this.DrawingPanelShanghai1.getEcllipseClipping();
            this.DrawingPanelShanghai1.clipLines();
            this.DrawingPanelShanghai1.tracingPolygons();
            this.DrawingPanelShanghai1.clipPolygons();

            this.DrawingPanelShanghai1.setCoordinate();
            this.DrawingPanelShanghai1.createLegend();
            this.repaint();
        }
    ...
    private void jMenuItem_OutputDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_OutputDataActionPerformed
        ...
        try {
            // TODO add your handling code here:
            this.DrawingPanelShanghai1.outputSurferGridData();
        } catch (IOException ex) {
            Logger.getLogger(FrmShanghaiMain.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public DrawingPanelShanghai getDrawingPanelShanghai() {
        return this.DrawingPanelShanghai1;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmShanghaiMain().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private DrawingPanelShanghai DrawingPanelShanghai1;
